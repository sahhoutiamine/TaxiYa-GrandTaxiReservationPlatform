                            ...
                            <div>
                                <div class="flex items-center gap-3 mb-2">
                                    ...
                                    <div class="flex items-center gap-1">
                                        ...
                                        <span class="text-sm font-bold text-dark">{{ number_format($trip->cheffeur->average_rating, 1) }}</span>
                                        <span class="text-xs text-gray-500">({{ $trip->cheffeur->ratings_count }} reviews)</span>
                                    </div>
                                </div>

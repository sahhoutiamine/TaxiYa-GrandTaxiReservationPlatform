    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="flex justify-between items-center py-4">
            ...
            <div class="hidden md:flex items-center gap-8">
                <a href="traveler/search.blade.php" class="text-gray-700 hover:text-primary font-medium transition-colors">Search Rides</a>
                <a href="#how-it-works" class="text-gray-700 hover:text-primary font-medium transition-colors">How It Works</a>
                <a href="auth/login.html" class="px-5 py-2.5 text-gray-700 font-semibold hover:text-primary transition-colors">Login</a>
                <a href="auth/register.html" class="px-6 py-2.5 bg-primary text-white font-semibold rounded-lg hover:bg-blue-700 transition-all shadow-lg shadow-primary/30">
                    Sign Up
                </a>
            </div>
        </div>
...
<section class="relative bg-gradient-to-br from-primary via-blue-700 to-blue-900 text-white py-20 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        <div class="grid md:grid-cols-2 gap-12 items-center">
            <div>
                <div class="inline-block px-4 py-2 bg-secondary/20 text-secondary rounded-full text-sm font-semibold mb-6">
                ...
                <p class="text-xl text-blue-100 mb-8 leading-relaxed">
                    No more waiting! Reserve your specific seat, know exact departure time, and pay online. Join 8 million Moroccans traveling smarter.
                </p>
            ...
            <div class="bg-white/95 backdrop-blur-sm rounded-2xl p-8 shadow-2xl">
                ...
                <form action="traveler/search.blade.php" method="GET">
                    ...
                    <button type="submit" class="w-full bg-primary text-white font-bold py-4 rounded-xl hover:bg-blue-700 transform hover:-translate-y-0.5 transition-all shadow-lg shadow-primary/40 text-lg">
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-3 gap-12">
            ...
            <div class="text-center">
                <div class="w-20 h-20 bg-gradient-to-br from-primary to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg">
                ...
                <p class="text-gray-600 leading-relaxed">Enter your departure city, destination, and travel date to see all available grand taxis.</p>
            </div>

            <!-- Step 2 -->
            <div class="text-center">
                <div class="w-20 h-20 bg-gradient-to-br from-secondary to-yellow-400 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg">
                    <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p class="text-gray-600 leading-relaxed">Select your preferred seat from the 6 available positions. See which seats are already taken.</p>
            </div>

            <!-- Step 3 -->
            <div class="text-center">
                <div class="w-20 h-20 bg-gradient-to-br from-accent to-emerald-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg">
                    <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p class="text-gray-600 leading-relaxed">Pay securely online and receive instant confirmation. Show up at departure time, your seat is guaranteed!</p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid md:grid-cols-2 gap-16 items-center">
                ...
                <div class="space-y-6">
                    <div class="flex gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Know exactly when your taxi departs. No unpredictable waiting times.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">See exact prices upfront. Pay online securely with no surprises.</p>
                        </div>
                    </div>
            ...
            <div class="relative">
                <img src="https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=600&h=600&fit=crop" alt="Grand Taxi" class="rounded-2xl shadow-2xl">
...
<section class="py-20 bg-gradient-to-r from-secondary to-yellow-300">
    <div class="max-w-5xl mx-auto px-6 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="driver/register.html" class="px-10 py-4 bg-dark text-white font-bold rounded-xl hover:bg-gray-800 transition-all shadow-xl text-lg">
                Register as Driver
            </a>
            <a href="driver/login.html" class="px-10 py-4 bg-white text-dark font-bold rounded-xl hover:bg-gray-100 transition-all shadow-xl text-lg">
                Driver Login
            </a>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid md:grid-cols-4 gap-12 mb-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="traveler/search.blade.php" class="text-gray-400 hover:text-white transition-colors">Search Rides</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="driver/register.html" class="text-gray-400 hover:text-white transition-colors">Become a Driver</a></li>
                    <li><a href="driver/login.html" class="text-gray-400 hover:text-white transition-colors">Driver Login</a></li>
